$(document).ready(function() {
	...
	$('#arrowOutro').click(function() {
		$('#isOne').hide('slide', {direction: 'down'}, 500, function(){
	...
	$('#arrow05l').click(function(){
		...
		if(altClick == 3) {
			$('#slide05_4').hide('slide', {direction: 'right'}, 500, function() {
				...
				altClick = 2;
				$('#arrow05r').show('slide', {direction: 'right'}, 200);
			});
		}
	});
	//arrow slide05 left
	$('#arrow05r').click(function(){
		if(altClick == 0) {
			$('#slide05_1').hide('slide', {direction: 'left'}, 500, function() {
				...
				altClick = 1;
				$('#arrow05l').show('slide', {direction: 'left'}, 200);
			});
		}
		if(altClick == 1) {
		...
		if(altClick == 2) {
			$('#slide05_3').hide('slide', {direction: 'left'}, 500, function() {
				...
				altClick = 3;
				$('#arrow05r').hide('slide', {direction: 'right'}, 200);
			});
		}
		if(altClick == 3) {
	...
	$('#arrow07l').click(function(){
		...
		if(solClick == 1) {
			$('#slide07_2').hide('slide', {direction: 'right'}, 500, function() {
				...
				solClick = 0;
				$('#arrow07l').hide('slide', {direction: 'left'}, 500);
			});
		}
		if(solClick == 2) {
		...
		if(solClick == 3) {
			$('#slide07_4').hide('slide', {direction: 'right'}, 500, function() {
				...
				solClick = 2;
				$('#arrow07r').show('slide', {direction: 'right'}, 500);
			});
		}
	});
	//arrow slide07 left
	$('#arrow07r').click(function(){
		...
		if(solClick == 2) {
			$('#slide07_3').hide('slide', {direction: 'left'}, 500, function() {
				...
				solClick = 3;
				$('#arrow07r').hide('slide', {direction: 'right'}, 500);
			});
		}
		if(solClick == 3) {
